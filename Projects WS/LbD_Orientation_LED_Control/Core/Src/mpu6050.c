...
mpu6050_status_t mpu6050_read(I2C_HandleTypeDef *hi2c, uint8_t register_address, uint8_t *buffer, uint32_t nbytes) {
    HAL_StatusTypeDef status = HAL_I2C_Mem_Read(hi2c, mpu6050_i2c_address << 1, register_address, 1, buffer, nbytes, I2C_TIMEOUT);
...
mpu6050_accelerometer_data_t mpu6050_accelerometer_calibration(const mpu6050_accelerometer_data_t *error_offset, mpu6050_accelerometer_data_t *raw_data) {
